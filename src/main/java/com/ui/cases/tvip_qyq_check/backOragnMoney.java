...
import com.ui.cases.oragnCase.chargeOrgan;
...
public class backOragnMoney extends Base {
    ...
    public void backOrgan() throws InterruptedException {
        ...
        double expectedqyqMoney = qyqMoney+doubleNum(money);
        double expectedkyMoney = kyMoney;
        ...
        AssertUtil.assertNumEquals(alqyqMoney,expectedqyqMoney);
        AssertUtil.assertNumEquals(alkyMoney,expectedkyMoney);
    ...
    public void overbackOrgan() throws InterruptedException {
        ...
        double expectedqyqMoney = qyqMoney;
        double expectedkyMoney = kyMoney;
