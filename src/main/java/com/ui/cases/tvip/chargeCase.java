...
public class chargeCase extends Base {
    ...
    public void chargeSuccess() throws InterruptedException {
        ...
        Thread.sleep(1000);
        double wMoney = doubleNum(getText(getElement("充值", "总部待领取金额")));
        ...
        Thread.sleep(2000);
        //实际待领取金额
        double alwMoney = doubleNum(getText(getElement("充值", "总部待领取金额")));
    ...
    public void rechargeFail() throws InterruptedException {
        ...
        click(getElement("充值", "账户管理按钮"));
        Thread.sleep(1000);
        String money1 = getText(getElement("充值", "总部待领取金额"));
